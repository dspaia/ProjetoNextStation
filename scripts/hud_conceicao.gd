...
@export_range(0, 59) var default_segundos := 50  # Tempo inicial em segundos
...
func end_game():
	if segundos == 0 and minutos == 0:
		...
		get_tree().change_scene_to_file("res://cenas/Sao_Judas.tscn")  # Altera a cena para a especificada

...
@export_range(0, 59) var default_segundos := 20  # Tempo inicial em segundos
...
func end_game():
	if segundos == 0 and minutos == 0:
		...
		get_tree().change_scene_to_file("res://cenas/Santa_Cruz.tscn") # Altera a cena para a especificada
